...
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', '../../dorelhaim_conquer/dorelhaim_conquer/addons/godotdetour/bin/', PathVariable.PathIsDirCreate))
